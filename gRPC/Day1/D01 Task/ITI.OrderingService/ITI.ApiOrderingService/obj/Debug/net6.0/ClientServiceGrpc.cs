...
namespace ITI.GrpcPaymentService.Server.Protos {
  public static partial class Payment
  {
    ...
    public partial class PaymentClient : grpc::ClientBase<PaymentClient>
    {
      ...
      [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
      public virtual global::ITI.GrpcPaymentService.Server.Protos.PaymentResponse CheckBalance(global::ITI.GrpcPaymentService.Server.Protos.PaymentRequest request, grpc::Metadata headers = null, global::System.DateTime? deadline = null, global::System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
      {
        return CheckBalance(request, new grpc::CallOptions(headers, deadline, cancellationToken));
      }
      [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
      public virtual global::ITI.GrpcPaymentService.Server.Protos.PaymentResponse CheckBalance(global::ITI.GrpcPaymentService.Server.Protos.PaymentRequest request, grpc::CallOptions options)
      {
        return CallInvoker.BlockingUnaryCall(__Method_CheckBalance, null, options, request);
      }
      [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
      public virtual grpc::AsyncUnaryCall<global::ITI.GrpcPaymentService.Server.Protos.PaymentResponse> CheckBalanceAsync(global::ITI.GrpcPaymentService.Server.Protos.PaymentRequest request, grpc::Metadata headers = null, global::System.DateTime? deadline = null, global::System.Threading.CancellationToken cancellationToken = default(global::System.Threading.CancellationToken))
      {
        return CheckBalanceAsync(request, new grpc::CallOptions(headers, deadline, cancellationToken));
      }
      [global::System.CodeDom.Compiler.GeneratedCode("grpc_csharp_plugin", null)]
      public virtual grpc::AsyncUnaryCall<global::ITI.GrpcPaymentService.Server.Protos.PaymentResponse> CheckBalanceAsync(global::ITI.GrpcPaymentService.Server.Protos.PaymentRequest request, grpc::CallOptions options)
      {
