...
using MVCWebAppWith3Areas.Data;
using MVCWebAppWith3Areas.Models;

namespace MVCWebAppWith3Areas.Areas.HR.Controllers
{
    public class EmployeesController : Controller
    {
        private MVCWebAppWith3AreasContext db = new MVCWebAppWith3AreasContext();
